...
// Allocates a pinned, zero-initialized memory block of the given length (count * size), aligned to the length, or crashes.
...
uintptr_t tn_mem_virt_to_phys(const void* addr);
