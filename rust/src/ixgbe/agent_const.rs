...
impl<'a, 'b, const OUTPUTS: usize> AgentConst<'a, 'b, OUTPUTS> {
    pub fn create(env: &'b impl Environment<'b>, input: &'a mut DeviceInput<'a>, outputs: [&'a mut DeviceOutput<'a>; OUTPUTS]) -> AgentConst<'a, 'b, OUTPUTS> {
