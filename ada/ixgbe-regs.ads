...
package Ixgbe.Regs is
  ...
  function DCARXCTRL(n: VolatileUInt32) return VolatileUInt32 is (if n <= 63 then (16#0100C# + 16#40#*n) else (16#0D00C# + 16#40#*(n-64)));
  DCARXCTRL_UNKNOWN: constant := 2#1_0000_0000_0000#; -- BIT(12)

  function DCATXCTRL(n: VolatileUInt32) return VolatileUInt32 is (16#0600C# + 16#40#*n);
  ...
  function EIMC(n: VolatileUInt32) return VolatileUInt32 is (if n = 0 then 16#00888# else (16#00AB0# + 4*(n - 1)));

  FCCFG: constant := 16#03D00#;
  FCCFG_TFCE: constant := 2#1_1000#;-- BITS(3,4)

  function FCRTH(n: VolatileUInt32) return VolatileUInt32 is (16#03260# + 4*n);
  ...
  function FTQF(n: VolatileUInt32) return VolatileUInt32 is (16#0E600# + 4*n);
  ...
  function MPSAR(n: VolatileUInt32) return VolatileUInt32 is (16#0A600# + 4*n);

  function MTA(n: VolatileUInt32) return VolatileUInt32 is (16#05200# + 4*n);

  function PFUTA(n: VolatileUInt32) return VolatileUInt32 is (16#0F400# + 4*n);

  function PFVLVF(n: VolatileUInt32) return VolatileUInt32 is (16#0F100# + 4*n);

  function PFVLVFB(n: VolatileUInt32) return VolatileUInt32 is (16#0F200# + 4*n);

  function RDBAH(n: VolatileUInt32) return VolatileUInt32 is (if n <= 63 then (16#01004# + 16#40#*n) else (16#0D004# + 16#40#*(n-64)));

  function RDBAL(n: VolatileUInt32) return VolatileUInt32 is (if n <= 63 then (16#01000# + 16#40#*n) else (16#0D000# + 16#40#*(n-64)));

  function RDLEN(n: VolatileUInt32) return VolatileUInt32 is (if n <= 63 then (16#01008# + 16#40#*n) else (16#0D008# + 16#40#*(n-64)));
  ...
  function RDT(n: VolatileUInt32) return VolatileUInt32 is (if n <= 63 then (16#01018# + 16#40#*n) else (16#0D018# + 16#40#*(n-64)));
  ...
  function RXDCTL(n: VolatileUInt32) return VolatileUInt32 is (if n <= 63 then (16#01028# + 16#40#*n) else (16#0D028# + 16#40#*(n-64)));
  RXDCTL_ENABLE: constant := 2#10_0000_0000_0000_0000_0000_0000#; -- BIT(25)

  function RXPBSIZE(n: VolatileUInt32) return VolatileUInt32 is (16#03C00# + 4*n);
  ...
  function SRRCTL(n: VolatileUInt32) return VolatileUInt32 is (if n <= 63 then (16#01014# + 16#40#*n) else (16#0D014# + 16#40#*(n-64)));
  ...
  function TDBAH(n: VolatileUInt32) return VolatileUInt32 is (16#06004# + 16#40#*n);

  function TDBAL(n: VolatileUInt32) return VolatileUInt32 is (16#06000# + 16#40#*n);

  function TDLEN(n: VolatileUInt32) return VolatileUInt32 is (16#06008# + 16#40#*n);

  function TDT(n: VolatileUInt32) return VolatileUInt32 is (16#06018# + 16#40#*n);

  function TDWBAH(n: VolatileUInt32) return VolatileUInt32 is (16#0603C# + 16#40#*n);

  function TDWBAL(n: VolatileUInt32) return VolatileUInt32 is (16#06038# + 16#40#*n);

  function TXDCTL(n: VolatileUInt32) return VolatileUInt32 is (16#06028# + 16#40#*n);
  ...
  function TXPBSIZE(n: VolatileUInt32) return VolatileUInt32 is (16#0CC00# + 4*n);
