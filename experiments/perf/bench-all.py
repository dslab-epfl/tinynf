...
#bench('../csharp', 'C#, JIT', {'TN_MODE': '3'})
#bench('../csharp', 'C# extended, JIT', {})
#bench('../csharp', 'C#, AOT', {'TN_MODE': '3', 'TN_CSHARP_AOT': 'y'})
#bench('../csharp', 'C# extended, AOT', {'TN_CSHARP_AOT': 'y'})
bench('../csharp', 'C# queues, AOT', {'TN_MODE': '2', 'TN_CSHARP_AOT': 'y'})
#bench('../rust', 'Rust', {})
